          ...
          parameters: [
            {
              ...
              in: 'path',
              required: true,
              description: 'EVM wallet address (0x + 40 hex) or an ENS name (e.g. vitalik.eth), which is resolved on Ethereum mainnet before screening.',
              schema: { type: 'string' },
      ...
      schemas: {
        ...
        Attestation: {
          ...
          properties: {
            ...
            purpose: { type: 'string', enum: ['compliance-screening-result', 'verification-fixture', 'public-action-receipt', 'swap-action'] },
